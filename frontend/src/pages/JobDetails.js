...
export default function JobDetails() {
  ...
  if (loading) {
    // Skeleton structuré (source unique dans SkeletonLoader) : réplique la
    // hauteur du contenu réel (bouton retour + carte en-tête + carte
    // description + sidebar info/client) pour que le footer ancré (flex-1,
    // cf. App.js) ne remonte pas au swap spinner → contenu — le spinner 50vh
    // laissait le footer remonter de ~50vh au chargement (CLS résiduel
    // ~0.034 sur JobDetails).
