...
const translations = {
  fr: {
    ...
    myJobs: 'Mes emplois',
    myRecentJobs: 'Mes emplois récents',
    ...
    profileCreated: 'Profil travailleur créé avec succès',
    profileCreateError: 'Erreur lors de la création',
    paymentAccountsUpdated: 'Comptes de paiement mis à jour avec succès',
    photoUpdated: 'Photo de profil mise à jour avec succès !',
    photoDeleted: 'Photo de profil supprimée !',
    photoReadySave: 'Photo prête - cliquez "Enregistrer" pour confirmer',
    loginSuccess: 'Connexion réussie !',
    loginFailed: 'Échec de la connexion',
    registerStepSuccess: 'Informations enregistrées ! Étape suivante...',
    availableStatus: 'Disponible',
    unavailableStatus: 'Non disponible',
    locationNotSpecified: 'Location non spécifiée',
    ...
    signIn: 'Se connecter',
    type: 'Type',
    experience1to2: '1-2 ans',
    experience3to5: '3-5 ans',
    experience6to10: '6-10 ans',
    experience11to15: '11-15 ans',
    experience16to20: '16-20 ans',
    experience20plus: 'Plus de 20 ans',
    ...
    paymentAccountsRequiredTitle: 'Comptes de paiement requis',
    configureMyPaymentAccounts: 'Configurer mes comptes de paiement',
    returnToDashboard: 'Retour au tableau de bord',
    accountType: 'Type de compte',
    currentlyLinkedAccounts: 'Comptes liés actuellement',
    networkStatusLabel: 'État du réseau',
    activeOptimizations: 'Optimisations actives',
    installKojo: 'Installer Kojo',
    addKojoHome: "Ajoutez Kojo à votre écran d'accueil pour un accès rapide",
    install: 'Installer',
    later: 'Plus tard',
    ...
    clickToChooseSimple: 'Cliquez pour choisir',
    dragImageHere: 'ou glissez une image ici',
    imageFormatsLimit: "PNG, JPG, WEBP jusqu'à 5MB",
    autoOptimizedFastConnection: '✨ Optimisation automatique pour connexion rapide',
    uploadInProgress: 'Upload en cours...',
    choosePhoto: 'Choisir une photo',
    photoVisibleAllUsers: 'Votre photo de profil sera visible par tous les utilisateurs de Kojo',
    yourProfilePhoto: 'Votre photo de profil',
    makeProposal: 'Faire une proposition',
    proposedAmount: 'Montant proposé (FCFA)',
    estimatedCompletionTime: "Temps d'exécution estimé",
    messageToClient: 'Message au client',
    sendProposal: 'Envoyer la proposition',
    proposalSubmitError: 'Erreur lors de la soumission',
    proposalTimePlaceholder: '2 heures, 1 jour, etc.',
    proposalMessagePlaceholder: 'Expliquez pourquoi vous êtes le bon choix pour ce travail...',
    requiredSkills: 'Compétences requises',
    budgetMinLabel: 'Budget minimum (FCFA)',
    budgetMaxLabel: 'Budget maximum (FCFA)',
    estimatedDuration: 'Durée estimée',
    deadlineOptional: 'Date limite (optionnelle)',
    publishJobLabel: "Publier l'emploi",
    jobBudgetRangeError: 'Le budget maximum doit être supérieur au budget minimum',
    jobCreateError: 'Erreur lors de la création',
    addressPlaceholder: 'Ex: Dakar, Plateau, Rue 10',
    requiredSkillsPlaceholder: 'Ex: Plomberie, Électricité...',
    durationPlaceholder: 'Ex: 2-3 heures, 1 jour...',
    descriptionPlaceholder: 'Décrivez le travail en détail...',
    titlePlaceholder: 'Ex: Réparation de robinet qui fuit',
    validStatus: 'Valide',
    insufficientStatus: 'Insuffisant',
    limitedAccess: 'Accès limité',
    connectionRestored: 'Connexion rétablie'
  },
  en: {
    ...
    profileCreated: 'Worker profile created successfully',
    profileCreateError: 'Error during creation',
    paymentAccountsUpdated: 'Payment accounts updated successfully',
    photoUpdated: 'Profile photo updated successfully!',
    photoDeleted: 'Profile photo deleted!',
    photoReadySave: 'Photo ready - click "Save" to confirm',
    loginSuccess: 'Login successful!',
    loginFailed: 'Login failed',
    registerStepSuccess: 'Information saved! Next step...',
    ...
    signIn: 'Sign In',
    type: 'Type',
    experience1to2: '1-2 years',
    experience3to5: '3-5 years',
    experience6to10: '6-10 years',
    experience11to15: '11-15 years',
    experience16to20: '16-20 years',
    experience20plus: 'More than 20 years',
    skillsHelpClientsFindYou: 'Your skills will help clients find you',
    experienceReassuresClients: 'Your experience reassures clients about your qualifications',
    canEditProfileLater: 'You will be able to edit this information in your profile',
    refreshPage: 'Refresh page',
    unexpectedErrorTitle: 'Oops! Something went wrong',
    unexpectedErrorText: 'An unexpected error occurred. Please refresh the page.',
    checkingAccess: 'Checking access...',
    loginRequired: 'Login required',
    paymentAccountsRequiredTitle: 'Payment accounts required',
    configureMyPaymentAccounts: 'Configure my payment accounts',
    ...
    installKojo: 'Install Kojo',
    addKojoHome: 'Add Kojo to your home screen for quick access',
    install: 'Install',
    later: 'Later',
    ...
    clickToChooseSimple: 'Click to choose',
    dragImageHere: 'or drag an image here',
    imageFormatsLimit: 'PNG, JPG, WEBP up to 5MB',
    autoOptimizedFastConnection: '✨ Automatic optimization for fast connection',
    uploadInProgress: 'Uploading...',
    choosePhoto: 'Choose a photo',
    photoVisibleAllUsers: 'Your profile photo will be visible to all Kojo users',
    yourProfilePhoto: 'Your profile photo',
    makeProposal: 'Make a proposal',
    proposedAmount: 'Proposed amount (FCFA)',
    estimatedCompletionTime: 'Estimated completion time',
    messageToClient: 'Message to client',
    sendProposal: 'Send proposal',
    proposalSubmitError: 'Error while submitting',
    proposalTimePlaceholder: '2 hours, 1 day, etc.',
    proposalMessagePlaceholder: 'Explain why you are the right choice for this job...',
    requiredSkills: 'Required skills',
    budgetMinLabel: 'Minimum budget (FCFA)',
    budgetMaxLabel: 'Maximum budget (FCFA)',
    estimatedDuration: 'Estimated duration',
    deadlineOptional: 'Deadline (optional)',
    publishJobLabel: 'Post job',
    jobBudgetRangeError: 'Maximum budget must be greater than minimum budget',
    jobCreateError: 'Error while creating',
    addressPlaceholder: 'Ex: Dakar, Plateau, Street 10',
    requiredSkillsPlaceholder: 'Ex: Plumbing, Electrical...',
    durationPlaceholder: 'Ex: 2-3 hours, 1 day...',
    descriptionPlaceholder: 'Describe the job in detail...',
    titlePlaceholder: 'Ex: Fix leaking faucet',
    validStatus: 'Valid',
  ...
  wo: {
    ...
    profileLoadError: 'Njuumte ci yéene profil bi',
    profileUpdated: 'Profil bi miy naat na !',
    profileCreated: 'Profil liggéeykat bi sorewaat na',
    profileCreateError: 'Njuumte ci sorewaat',
    paymentAccountsUpdated: 'Kont peyma yi miy naat nañu',
    photoUpdated: 'Nataal profil bi miy naat na !',
    photoDeleted: 'Nataal profil bi fey nañu ko !',
    photoReadySave: 'Nataal bi pare na - tobbal "Sàcc" ngir dëgg',
    loginSuccess: 'Dugg bi amee na !',
    loginFailed: 'Dugg bi amul',
    registerStepSuccess: 'Xam-xam yi sàcc nañu ! Etaap bi ci topp...',
    availableStatus: 'Am na',
    unavailableStatus: 'Amul',
    locationNotSpecified: 'Taxawaay mënul a feeñ',
    modifySearchCriteria: 'Jéemël soppi sa yoon yu seet.',
  ...
  bm: {
    ...
    profileLoadError: 'Fili profili doni na',
    profileUpdated: 'Profili labɛnna !',
    profileCreated: 'Baarakɛla profili dabɔra',
    profileCreateError: 'Fili dabɔli la',
    paymentAccountsUpdated: 'Sara kont labɛnna',
    photoUpdated: 'Profili ja labɛnna !',
    photoDeleted: 'Profili ja bɔra !',
    photoReadySave: 'Ja labɛnnen - "Mara" digi',
    loginSuccess: 'Don dafara !',
    loginFailed: 'Don ma dafa',
    registerStepSuccess: 'Kunnafoniw marala ! Taa ɲɛ...',
    availableStatus: 'Bɛ yen',
    unavailableStatus: 'Tɛ yen',
    locationNotSpecified: 'Yɔrɔ ma jira',
    modifySearchCriteria: 'I ka ɲinini fɛɛrɛ yɛlɛma.',
  ...
  mos: {
    ...
    profileLoadError: 'Tudgr n paam profili',
    profileUpdated: 'Profili toeema !',
    profileCreated: 'Tʋʋm-naab profili maana',
    profileCreateError: 'Tudgr maaneg pʋgẽ',
    paymentAccountsUpdated: 'Yaood kont toeema',
    photoUpdated: 'Profili foto toeema !',
    photoDeleted: 'Profili foto yiisa !',
    photoReadySave: 'Foto seglame - "Bĩng" n wilg',
    loginSuccess: 'Kẽesg tõogame !',
    loginFailed: 'Kẽesg ka tõog ye',
    registerStepSuccess: 'Kibay bĩngame ! Tɩ n kẽng taoor...',
    availableStatus: 'Be be',
    unavailableStatus: 'Ka be ye',
    locationNotSpecified: 'Zĩig ka wilgi ye',
    modifySearchCriteria: 'Mak-y n toeem y baosg soayã.',
