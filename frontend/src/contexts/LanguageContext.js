...
const translations = {
  fr: {
    ...
    selectLanguageLabel: 'Choisir une langue',
    french: 'Français',
    english: 'English',
    wolof: 'Wolof',
    bambara: 'Bambara',
    ...
    sessionExpiredReconnect: 'Session expirée. Veuillez vous reconnecter.',
    networkConnectionError: 'Erreur de connexion. Vérifiez votre connexion internet.',
    ...
    feesLabel: 'Frais',
    ussdCode: 'Code USSD',
    methodSelected: 'Méthode sélectionnée',
    noPaymentMethodsRegion: 'Aucune méthode de paiement disponible pour votre région',
    youSelected: 'Vous avez sélectionné',
    paymentSummary: 'Résumé du paiement',
    serviceAmountLabel: 'Montant du service',
    transactionFees: 'Frais de transaction',
    totalToPay: 'Total à payer',
    automaticDistribution: 'Répartition automatique',
    platformCommission: 'Commission plateforme',
    viaMethodAutomaticTransfer: 'Via {method} - Transfert automatique',
    selectPaymentMethodPrompt: 'Veuillez sélectionner une méthode de paiement',
    processingDistribution: 'Traitement + Distribution...',
    payAmount: 'Payer',
    paymentSucceededDistribution: 'Paiement réussi avec distribution !',
    paymentFailed: 'Paiement échoué',
    ownerLabel: 'Propriétaire',
    workerLabel: 'Travailleur',
    visaMastercard: 'Visa, Mastercard',
    orangeMobileMoney: 'Mobile Money Orange',
    waveFreeTransfers: 'Transferts gratuits Wave',
    instantLabel: 'Instantané',
    bankAccount: 'Compte bancaire',
    availableAcrossWestAfrica: 'Disponible partout en Afrique de l\'Ouest',
    forBankTransfers: 'Pour transferts bancaires',
    ...
    bankCodeOptional: 'Code banque (optionnel)',
    branchOptional: 'Agence (optionnel)',
    whyTheseInfo: 'Pourquoi ces informations ?',
    bankRequiredFieldsInfo: 'Numéro de compte, nom du titulaire et banque sont obligatoires',
    bankOptionalFieldsInfo: 'Code banque et agence sont optionnels mais recommandés',
    bankTransferDirectInfo: 'Ces informations permettront les transferts bancaires directs',
    paymentInfoSecure: 'Vos informations de paiement sont sécurisées',
    requiredToReceivePayments: 'Nécessaire pour recevoir les paiements',
    requiredToMakePayments: 'Nécessaire pour effectuer les paiements',
    notConfigured: 'Non configuré',
    invalidOrangeMoneyNumber: 'Numéro Orange Money invalide',
    invalidWaveNumber: 'Numéro Wave invalide',
    completeRequiredBankFields: 'Veuillez remplir tous les champs obligatoires du compte bancaire',
    correctValidationErrors: 'Veuillez corriger les erreurs de validation',
    ...
    branchLabel: 'Agence',
    fullHolderName: 'Nom complet du titulaire',
    examplePrefix: 'Ex:',
  ...
  en: {
    ...
    sessionExpiredReconnect: 'Session expired. Please sign in again.',
    networkConnectionError: 'Connection error. Check your internet connection.',
    ...
    noPaymentMethodsRegion: 'No payment method available for your region',
    ...
    viaMethodAutomaticTransfer: 'Via {method} - Automatic transfer',
    selectPaymentMethodPrompt: 'Please select a payment method',
    processingDistribution: 'Processing + Distribution...',
    payAmount: 'Pay',
    paymentSucceededDistribution: 'Payment successful with distribution!',
    paymentFailed: 'Payment failed',
    ownerLabel: 'Owner',
    workerLabel: 'Worker',
    visaMastercard: 'Visa, Mastercard',
    orangeMobileMoney: 'Orange Mobile Money',
    waveFreeTransfers: 'Free Wave transfers',
    instantLabel: 'Instant',
    bankAccount: 'Bank account',
    availableAcrossWestAfrica: 'Available across West Africa',
    forBankTransfers: 'For bank transfers',
    bankAccountNumber: 'Bank account number',
    accountHolderName: 'Account holder name',
    selectBank: 'Select a bank',
    otherBank: 'Other bank',
    yourBankName: 'Your bank name',
    bankCodeOptional: 'Bank code (optional)',
    branchOptional: 'Branch (optional)',
    whyTheseInfo: 'Why this information?',
    bankRequiredFieldsInfo: 'Account number, account holder name and bank are required',
    bankOptionalFieldsInfo: 'Bank code and branch are optional but recommended',
    bankTransferDirectInfo: 'This information enables direct bank transfers',
    paymentInfoSecure: 'Your payment information is secure',
    requiredToReceivePayments: 'Required to receive payments',
    requiredToMakePayments: 'Required to make payments',
    notConfigured: 'Not configured',
    invalidOrangeMoneyNumber: 'Invalid Orange Money number',
    invalidWaveNumber: 'Invalid Wave number',
    completeRequiredBankFields: 'Please fill in all required bank account fields',
    correctValidationErrors: 'Please correct the validation errors',
    ...
    holderLabel: 'Holder',
    branchLabel: 'Branch',
    fullHolderName: 'Full holder name',
    examplePrefix: 'Ex:',
  ...
  wo: {
    ...
    showPassword: 'Wone kóodu dugub bi',
    hidePassword: 'Nëbb kóodu dugub bi',
    firstName: 'Tur',
    lastName: 'Sant',
    phone: 'Téléphone',
    ...
    selectLanguageLabel: 'Tannal làkk',
    french: 'Franse',
    english: 'Angale',
    wolof: 'Wolof',
    bambara: 'Bambara',
    ...
    invalidCredentials: 'Baatu jàll bi baaxul',
    incorrectPassword: 'Baatu jàll bi jubul.',
    sessionExpiredReconnect: 'Sésioŋ bi jeex na. Duggalaat.',
    networkConnectionError: 'Jokkoo bi dafa jafe. Seetal sa internet.',
    ...
    feesLabel: 'Frais',
    ussdCode: 'Code USSD',
    methodSelected: 'Yoonu fey bi nga tànn',
    noPaymentMethodsRegion: 'Amul yoonu fey ci sa gox',
    youSelected: 'Nga tànn',
    paymentSummary: 'Tënkub fey bi',
    serviceAmountLabel: 'Ndaray servisë bi',
    transactionFees: 'Frais transaction',
    totalToPay: 'Lëpp lu war a fey',
    automaticDistribution: 'Seddoo otomatik',
    platformCommission: 'Commission plateforme',
    viaMethodAutomaticTransfer: 'Jaarale ko ci {method} - transfert otomatik',
    selectPaymentMethodPrompt: 'Tànnalal benn yoonu fey',
    processingDistribution: 'Mi ngi defar ak seddoo...',
    payAmount: 'Fey',
    paymentSucceededDistribution: 'Fey bi am na ak seddoo !',
    paymentFailed: 'Fey bi antuwul',
    ownerLabel: 'Boroom bi',
    workerLabel: 'Liggéeykat',
    visaMastercard: 'Visa, Mastercard',
    orangeMobileMoney: 'Mobile Money Orange',
    waveFreeTransfers: 'Transferts yu amul frais Wave',
    instantLabel: 'Instantané',
    bankAccount: 'Konte bank',
    availableAcrossWestAfrica: 'Am na ci Afrika Sowwu bépp',
    forBankTransfers: 'Ngir transfert bank',
    bankAccountNumber: 'Lambar konte bank',
    accountHolderName: 'Tur boroom konte bi',
    selectBank: 'Tànn bank',
    otherBank: 'Beneen bank',
    yourBankName: 'Tur sa bank',
    bankCodeOptional: 'Kod bank (bu optional)',
    branchOptional: 'Agence (bu optional)',
    whyTheseInfo: 'Lu tax xibaar yii?',
    bankRequiredFieldsInfo: 'Lambar konte, tur boroom konte ak bank war na ñu am',
    bankOptionalFieldsInfo: 'Kod bank ak agence yi optional la waaye baax na ñu am',
    bankTransferDirectInfo: 'Xibaar yii dina may transfert bank bu jub',
    paymentInfoSecure: 'Sa xibaar fey yi aar nañu ko',
    requiredToReceivePayments: 'Soxla ngir jot peymaa',
    requiredToMakePayments: 'Soxla ngir def peymaa',
    notConfigured: 'Ñu ko defagul',
    invalidOrangeMoneyNumber: 'Lambar Orange Money baaxul',
    invalidWaveNumber: 'Lambar Wave baaxul',
    completeRequiredBankFields: 'Feesal bépp fan yu war ci konte bank bi',
    correctValidationErrors: 'Jubbal njuumte validation yi',
    updateError: 'Njuumte ci yeesal bi',
    saveError: 'Njuumte ci denc bi',
    accountNumberLabel: 'Lambar konte',
    bankNameLabel: 'Tur bank',
    accountHolderLabel: 'Tur boroom konte',
    accountLabel: 'Konte',
    bankLabel: 'Bank',
    holderLabel: 'Boroom',
    branchLabel: 'Agence',
    fullHolderName: 'Tur mat sëkk boroom konte bi',
    examplePrefix: 'Misaal:',
    ...
    activeOptimizations: 'Yeesal yi ñuy dox',
    addKojoHome: 'Yokk Kojo ci sa écran bu njëkk',
    appInstalled: 'App bi sampu na',
    autoOptimizedFastConnection: 'Optimizasionu otomatik ngir connexion bu gaaw',
    budgetMaxLabel: 'Bajat bu gëna mag',
    budgetMinLabel: 'Bajat bu gëna ndaw',
    addressPlaceholder: 'Misal: Plateau, Dakar, Senegaal',
    checkingAccess: 'Mi ngi saytu sañ-sañ yi...',
    choosePhoto: 'Tànn benn nataal',
    clickToChooseSimple: 'Bësal ngir tànn',
    close: 'Tëj',
    configureMyPaymentAccounts: 'Defar sama kontu fey yi',
    connectionRestored: 'Connexion bi dellusi na',
    currentlyLinkedAccounts: 'Kont yi ñu lëkkale léegi',
    deadlineOptional: 'Mucc gu bëgg (bu optional)',
    descriptionPlaceholder: 'Melaxal li nga bëgg...',
    dragImageHere: 'Riir nataal fii',
    durationPlaceholder: 'Misal: fan 3 walla waxtu 2',
    estimatedCompletionTime: 'Waxtu wu ñu xayma ngir jeex',
    estimatedDuration: 'Yàgg wu ñu xayma',
    imageFormatsLimit: 'PNG, JPG, WEBP ba 5MB',
    install: 'Samp',
    installKojo: 'Samp Kojo',
    insufficientStatus: 'Doyul',
    jobBudgetRangeError: 'Bajat bu gëna ndaw war na nekk suuf bajat bu gëna mag',
    jobCreateError: 'Njuumte ci sosu liggéey bi',
    later: 'Ci kanam',
    limitedAccess: 'Ag yi ñu yemal',
    loadingLabel: 'Mi ngi yebbi...',
    loginRequired: 'Duggalal sa bopp ba noppi',
    makeProposal: 'Def ndigal',
    messageToClient: 'Bataaxal ngir kliyan',
    networkStatusLabel: 'Tolluwaayu réseau',
    paymentAccountsLoadError: 'Njuumte ci yebbi kontu fey yi',
    paymentAccountsRequiredTitle: 'Kontu fey yu war a am',
    photoUploadedSuccessfully: 'Nataal bi yebbu na bu baax! 📸',
    photoVisibleAllUsers: 'Sa nataalu profil dina feeñ ci jëfandikookat yépp',
    proposalMessagePlaceholder: 'Waxal li ngay jëfandikoo ngir jëbbal sa ndigal',
    proposalSubmitError: 'Njuumte ci yónnee ndigal bi',
    proposalTimePlaceholder: 'Misal: fan 2',
    proposedAmount: 'Xaalis bi nga ñaan (FCFA)',
    publishJobLabel: 'Yégle liggéey bi',
    refreshPage: 'Yeesal xët wi',
    requiredSkills: 'Mën-mën yu ñu soxla',
    requiredSkillsPlaceholder: 'Teg benn mën-mën te bësal Enter',
    returnToDashboard: 'Dellu ci dashboard',
    sendProposal: 'Yónnee ndigal bi',
    titlePlaceholder: 'Misal: réparation plomberie urgente',
    unexpectedErrorText: 'Am na jafe-jafe bu ñu seetul. Jéemaatal.',
    unexpectedErrorTitle: 'Jafe-jafe bu ñu seetul',
    transactionIdLabel: 'ID transaction',
    unknownCountry: 'Réew mi xamunu ko',
    uploadInProgress: 'Mi ngi yebbi...',
    validStatus: 'Baax na',
    yourProfilePhoto: 'Sa nataalu profil',
  },
  bm: {
    // Navigation (Bambara)
    home: 'So',
    ...
    showPassword: 'Daɲègafe jira',
    hidePassword: 'Daɲègafe dogo',
    firstName: 'Tɔgɔ fɔlɔ',
    lastName: 'Tɔgɔ laban',
    phone: 'Telefɔni',
    ...
    selectLanguageLabel: 'Kan sugandi',
    french: 'Faransi',
    english: 'Angilɛ',
    wolof: 'Wolof',
    bambara: 'Bamanankan',
    ...
    invalidCredentials: 'Mot de passe tɛ bɛn',
    incorrectPassword: 'Mot de passe ma nyi.',
    sessionExpiredReconnect: 'Session banna. Aw ka don ko kura.',
    networkConnectionError: 'Connexion filɛli ye. Aw ka internet lajɛ.',
    ...
    feesLabel: 'Frais',
    ussdCode: 'USSD code',
    methodSelected: 'Sara fɛɛrɛ min sugandilen',
    noPaymentMethodsRegion: 'Sara fɛɛrɛ si tɛ i ka mara la',
    youSelected: 'I sugandila',
    paymentSummary: 'Sara surun',
    serviceAmountLabel: 'Baara hakɛ',
    transactionFees: 'Transaction frais',
    totalToPay: 'Foyi bɛɛ sara',
    automaticDistribution: 'Tilalen automatique',
    platformCommission: 'Plateforme commission',
    viaMethodAutomaticTransfer: '{method} fɛ ka tɛmɛn - transfert automatique',
    selectPaymentMethodPrompt: 'I ka sara fɛɛrɛ dɔ sugandi',
    processingDistribution: 'Bɛ sarali ni tilalen kɛ...',
    payAmount: 'Sara',
    paymentSucceededDistribution: 'Sarali kɛra ni tilalen ye !',
    paymentFailed: 'Sarali ma se',
    ownerLabel: 'Tigi',
    workerLabel: 'Baarakɛla',
    visaMastercard: 'Visa, Mastercard',
    orangeMobileMoney: 'Orange Mobile Money',
    waveFreeTransfers: 'Wave transfertw bila sari',
    instantLabel: 'Sofali',
    bankAccount: 'Banki konto',
    availableAcrossWestAfrica: 'A bɛ se ka baara kɛ Afrika tilema bɛɛ',
    forBankTransfers: 'Banki transfɛriw kama',
    bankAccountNumber: 'Banki konto nimɔrɔ',
    accountHolderName: 'Konto tigi tɔgɔ',
    selectBank: 'Banki sugandi',
    otherBank: 'Banki wɛrɛ',
    yourBankName: 'I ka banki tɔgɔ',
    bankCodeOptional: 'Banki kode (optionnel)',
    branchOptional: 'Agence (optionnel)',
    whyTheseInfo: 'Munna nin kunnafoniw ma?',
    bankRequiredFieldsInfo: 'Konto nimɔrɔ, konto tigi tɔgɔ ani banki bɛ se ka kɛ',
    bankOptionalFieldsInfo: 'Banki kode ani agence ye optionnel ye nka olu bɛ nafama',
    bankTransferDirectInfo: 'Nin kunnafoniw bɛ banki transfɛriw ɲɛnabɔ nɔgɔn',
    paymentInfoSecure: 'I ka sara kunnafoniw lakana don',
    requiredToReceivePayments: 'A mago bɛ saraw sɔrɔli kama',
    requiredToMakePayments: 'A mago bɛ saraw kɛli kama',
    notConfigured: 'A ma labɛn',
    invalidOrangeMoneyNumber: 'Orange Money nimɔrɔ tɛ se',
    invalidWaveNumber: 'Wave nimɔrɔ tɛ se',
    completeRequiredBankFields: 'Banki konto ka champs wajibuw bɛɛ lafa',
    correctValidationErrors: 'Validation filiw ɲɛnabɔ',
    updateError: 'Fili bɛ mise à jour la',
    saveError: 'Fili bɛ marali la',
    accountNumberLabel: 'Konto nimɔrɔ',
    bankNameLabel: 'Banki tɔgɔ',
    accountHolderLabel: 'Konto tigi tɔgɔ',
    accountLabel: 'Konto',
    bankLabel: 'Banki',
    holderLabel: 'Tigi',
    branchLabel: 'Agence',
    fullHolderName: 'Konto tigi tɔgɔ dafalen',
    examplePrefix: 'Misali:',
    ...
    activeOptimizations: 'Yɛlɛma minnu bɛ baara',
    addKojoHome: 'Kojo fara i ka home ekran kan',
    appInstalled: 'App ye sigi',
    autoOptimizedFastConnection: 'Optimisation automatique ka kɛ connexion ye ka teli',
    budgetMaxLabel: 'Wari caya',
    budgetMinLabel: 'Wari dɔgɔya',
    addressPlaceholder: 'Misali: Plateau, Dakar, Senegali',
    checkingAccess: 'Bɛ sira ɲini...',
    choosePhoto: 'Foto sugandi',
    clickToChooseSimple: 'A digi walasa ka sugandi',
    close: 'Da',
    configureMyPaymentAccounts: 'N ka sara kontow labɛn',
    connectionRestored: 'Connexion segin na',
    currentlyLinkedAccounts: 'Kontow minnu siralen don sisan',
    deadlineOptional: 'Dɔnni waati (optionnel)',
    descriptionPlaceholder: 'A fɔli...',
    dragImageHere: 'Ja foto la yan',
    durationPlaceholder: 'Misali: tile 3 walima lɛrɛ 2',
    estimatedCompletionTime: 'Waati min bɛ hakili ka ban',
    estimatedDuration: 'Waati min bɛ to',
    imageFormatsLimit: 'PNG, JPG, WEBP fo ka se 5MB',
    install: 'Sigili',
    installKojo: 'Kojo sigi',
    insufficientStatus: 'A ma da ka',
    jobBudgetRangeError: 'Wari dɔgɔya tɛ se ka tɛmɛn wari caya la',
    jobCreateError: 'Fili bɛ baara dafalen na',
    later: 'Kɔfɛ',
    limitedAccess: 'Sira dantigɛ',
    loadingLabel: 'Bɛ makɔnɔ...',
    loginRequired: 'I ka don d’abord',
    makeProposal: 'Hakɛ kɛ',
    messageToClient: 'Cikan ye kliyan ma',
    networkStatusLabel: 'Reseau jaabi',
    paymentAccountsRequiredTitle: 'Sara kontow bɛ se ka kɛ',
    photoUploadedSuccessfully: 'Foto lasigi ka ɲi! 📸',
    photoVisibleAllUsers: 'I ka profil foto bɛna yɛrɛmɔgɔ bɛɛ ye',
    proposalMessagePlaceholder: 'I ka kuma sɛbɛn walasa ka hakɛ di',
    proposalSubmitError: 'Fili bɛ hakɛ bila na',
    proposalTimePlaceholder: 'Misali: tile 2',
    proposedAmount: 'Wari min i bɛ fɛ (FCFA)',
    publishJobLabel: 'Baara bila',
    refreshPage: 'Nyɛsin ka segin',
    requiredSkills: 'Hakilitigiw minnu bɛ se ka kɛ',
    requiredSkillsPlaceholder: 'Se kelen sɛbɛn ka Enter digi',
    returnToDashboard: 'Segin ka taa dashboard la',
    sendProposal: 'Hakɛ ci',
    titlePlaceholder: 'Misali: réparation plomberie joona',
    unexpectedErrorText: 'Fili dɔ bɛ yen min ma dɔn. I ye a kɛ ko kura.',
    unexpectedErrorTitle: 'Fili min ma dɔn',
    transactionIdLabel: 'Transaction ID',
    unknownCountry: 'Jamana ma dɔn',
    uploadInProgress: 'Bɛ lasigi...',
    validStatus: 'A bɛ se',
    yourProfilePhoto: 'I ka profil foto',
  },
  mos: {
    ...
    email: 'E-mail',
    password: 'Kũum sebre',
    showPassword: 'Wilg kũum sebre',
    hidePassword: 'Solg kũum sebre',
    firstName: 'Yʋʋr pipi',
    ...
    selectLanguageLabel: 'Sugri gomde',
    french: 'Farãsi',
    english: 'Anglais',
    wolof: 'Wolof',
    bambara: 'Bambara',
    ...
    invalidCredentials: 'Mot de passe wã ka tɩrg ye',
    incorrectPassword: 'Mot de passe yaa kaalem.',
    sessionExpiredReconnect: 'Session yaa saame. Pẽesg n taaba.',
    networkConnectionError: 'Connexion yaa toe. Gese fo internet wã.',
    ...
    feesLabel: 'Frais',
    ussdCode: 'USSD code',
    methodSelected: 'Yaool soaba sẽn sugri',
    noPaymentMethodsRegion: 'Yaool soaba ka be f tẽngrẽ ye',
    youSelected: 'F sugra',
    paymentSummary: 'Yaool sẽn pidsgo',
    serviceAmountLabel: 'Tʋʋmã ligdi',
    transactionFees: 'Transaction frais',
    totalToPay: 'Ligdi fãa sẽn segd',
    automaticDistribution: 'Bʋsgo otomatik',
    platformCommission: 'Plateforme commission',
    viaMethodAutomaticTransfer: 'Zãmsgo ne {method} - transfert otomatik',
    selectPaymentMethodPrompt: 'Sugr yaool soaba yembre',
    processingDistribution: 'A maanega yaool n bʋsa...',
    payAmount: 'Yaool',
    paymentSucceededDistribution: 'Yaool tõogame ne bʋsgo !',
    paymentFailed: 'Yaool ka tõog ye',
    ownerLabel: 'Soabã',
    workerLabel: 'Tʋʋm-neda',
    visaMastercard: 'Visa, Mastercard',
    orangeMobileMoney: 'Orange Mobile Money',
    waveFreeTransfers: 'Wave transfert zaalem',
    instantLabel: 'Wakat kelen',
    bankAccount: 'Bãnk konto',
    availableAcrossWestAfrica: 'A be Afrika lɩgulsgã fãa pʋgẽ',
    forBankTransfers: 'Bãnk tʋʋsgã yĩnga',
    bankAccountNumber: 'Bãnk konto lambre',
    accountHolderName: 'Konto soabã yʋʋre',
    selectBank: 'Yãk bãnk',
    otherBank: 'Bãnk a to',
    yourBankName: 'F bãnk yʋʋre',
    bankCodeOptional: 'Bãnk code (optionnel)',
    branchOptional: 'Agence (optionnel)',
    whyTheseInfo: 'Boe yĩng tɩ koɛɛg kãens?',
    bankRequiredFieldsInfo: 'Konto lambre, konto soabã yʋʋre la bãnkã sẽn kɛ',
    bankOptionalFieldsInfo: 'Bãnk code la agence yaa optionnel la b paam panga',
    bankTransferDirectInfo: 'Koɛɛg kãens na n tall bãnk tʋʋsg to-to',
    paymentInfoSecure: 'F yaool koɛɛgã gũusame',
    requiredToReceivePayments: 'A kɛ n na n sɔr yaool',
    requiredToMakePayments: 'A kɛ n na n kɛ yaool',
    notConfigured: 'A ma maan ye',
    invalidOrangeMoneyNumber: 'Orange Money lambre ka soma',
    invalidWaveNumber: 'Wave lambre ka soma',
    completeRequiredBankFields: 'Pids bãnk konto champs sẽn kɛa wã fãa',
    correctValidationErrors: 'Segl validation yelle',
    updateError: 'Yelle n togs mise à jour',
    saveError: 'Yelle n togs dʋkgre',
    accountNumberLabel: 'Konto lambre',
    bankNameLabel: 'Bãnk yʋʋre',
    accountHolderLabel: 'Konto soabã yʋʋre',
    accountLabel: 'Konto',
    bankLabel: 'Bãnk',
    holderLabel: 'Soaba',
    branchLabel: 'Agence',
    fullHolderName: 'Konto soabã yʋʋr pʋga',
    examplePrefix: 'Misaal:',
    ...
    activeOptimizations: 'Yɛlse sẽn tʋmda',
    addKojoHome: 'Paam Kojo f home écran n pʋgẽ',
    appInstalled: 'App wã sigame',
    autoOptimizedFastConnection: 'Optimisation automatique n na n sɔng connexion sẽn yaa tʋlli',
    budgetMaxLabel: 'Ligdi sẽn yɩɩdga',
    budgetMinLabel: 'Ligdi sẽn pʋg ninsaal',
    addressPlaceholder: 'Misaal: Plateau, Dakar, Senegaal',
    checkingAccess: 'A gese sañ-sañ...',
    choosePhoto: 'Sugri pɩture',
    clickToChooseSimple: 'Pĩg n sugri',
    close: 'Yõ',
    configureMyPaymentAccounts: 'Mãneg m yaool konto-rãmba',
    connectionRestored: 'Connexion lebgame',
    currentlyLinkedAccounts: 'Konto-rãmba sẽn sigse sisan',
    deadlineOptional: 'Dãmba sẽn pa tar neere',
    descriptionPlaceholder: 'Gʋls goama...',
    dragImageHere: 'Zu pɩture n yiin la',
    durationPlaceholder: 'Misaal: daar 3 bɩ wakat 2',
    estimatedCompletionTime: 'Wakat sẽn yɩɩd n sɛ',
    estimatedDuration: 'Wakat sẽn yɩɩd',
    imageFormatsLimit: 'PNG, JPG, WEBP fo 5MB',
    install: 'Sig',
    installKojo: 'Sig Kojo',
    insufficientStatus: 'A ka to',
    jobBudgetRangeError: 'Ligdi sẽn pʋg ka tõe n yɩɩd ligdi sẽn yɩɩdga',
    jobCreateError: 'Yelle n togs tʋʋmã ningre',
    later: 'Laafi',
    limitedAccess: 'Sira sẽn yaa bilfu',
    loadingLabel: 'A watda...',
    loginRequired: 'Kẽ taaba',
    makeProposal: 'Tʋm tẽngre',
    messageToClient: 'Koɛɛse n na daaba',
    networkStatusLabel: 'Réseau wẽnda',
    paymentAccountsRequiredTitle: 'Yaool konto-rãmba sẽn kɛ',
    photoVisibleAllUsers: 'F profil pɩture wã na n yẽg ninsaal bãmb ye',
    proposalMessagePlaceholder: 'Gʋls f koɛɛse n na tẽngre',
    proposalSubmitError: 'Yelle n togs tẽngre tʋmgre',
    proposalTimePlaceholder: 'Misaal: daar 2',
    proposedAmount: 'Ligdi f sẽn baood (FCFA)',
    publishJobLabel: 'Kibar tʋʋmã',
    refreshPage: 'Lebg n ges xëtã',
    requiredSkills: 'Minimã sẽn kɛ',
    requiredSkillsPlaceholder: 'Gʋls minimã a yembr n pĩg Enter',
    returnToDashboard: 'Lebg n ta tableau de bord',
    sendProposal: 'Tʋm tẽngre',
    titlePlaceholder: 'Misaal: réparation plomberie n kiire',
    unexpectedErrorText: 'Yelle a yembr n yɩɩda. Lebg n maan.',
    unexpectedErrorTitle: 'Yelle sẽn ka bãng',
    transactionIdLabel: 'ID bãngr yõk',
    unknownCountry: 'Tẽng ka bãng',
    uploadInProgress: 'A yinga...',
    validStatus: 'A yɩɩ neere',
    yourProfilePhoto: 'F profil pɩture',
  }
};
