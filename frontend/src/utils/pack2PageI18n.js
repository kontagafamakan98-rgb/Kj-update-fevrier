...
const pages = {
  createJob: {
    ...
    en: {
      ...
      preciseLocationReady: 'GPS location ready for the worker',
      preciseLocationHelp: 'The map and coordinates will be saved so the worker can open Google Maps or Apple Maps directly.',
      mapPreviewTitle: 'Job location preview',
      coordinatesSaved: 'Saved coordinates: {lat}, {lng}',
      budgetLabel: 'Budget (XOF) *',
  ...
  paymentVerification: {
    fr: {
      ...
      stepAccess: 'Vérification email',
      registrationErrorTitle: 'Erreur d\'inscription',
      finalizing: 'Création du compte...',
      checkingAccounts: 'Validation finale des comptes de paiement',
      backToRegister: '← Retour à la vérification email',
    ...
    en: {
      ...
      stepAccess: 'Email verification',
      registrationErrorTitle: 'Registration error',
      finalizing: 'Creating account...',
      checkingAccounts: 'Final validation of payment accounts',
      backToRegister: '← Back to email verification',
...
pages.jobReviews.wo = withBase(pages.jobReviews.fr, {
  title: '⭐ Avis ak nos',
...
pages.jobReviews.bm = withBase(pages.jobReviews.fr, {
  title: '⭐ Hakɛ ni jatew',
...
pages.jobReviews.mos = withBase(pages.jobReviews.fr, {
