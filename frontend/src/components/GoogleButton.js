...
/**
 * Bouton « Continuer avec Google » (SSO). Masqué si le client_id Google n'est
 * pas configuré (VITE_GOOGLE_CLIENT_ID). Le flux est déclenché par `onClick` :
 * le parent appelle loginWithGoogle/linkGoogleAccount du AuthContext et gère
 * la réponse (création, connexion, fusion, onboarding).
 */
export default function GoogleButton({ onClick, label, disabled = false }) {
