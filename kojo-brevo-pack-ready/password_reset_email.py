...
def send_password_reset_email(to_email, code, expires_in_minutes=10):
    ...
    <div style=\"font-family:Arial,sans-serif;max-width:560px;margin:0 auto;padding:24px;background:#ffffff;color:#111827;\">
      ...
      <p style=\"font-size:16px;line-height:1.6;\">Voici votre code de réinitialisation :</p>
      ...
      <p style=\"font-size:16px;line-height:1.6;\">Ce code expire dans <strong>{expires_in_minutes} minutes</strong>.</p>
      <p style=\"font-size:14px;line-height:1.6;color:#6b7280;\">Si vous n'avez pas demandé cette réinitialisation, ignorez simplement ce message.</p>
      <p style=\"font-size:14px;line-height:1.6;color:#6b7280;\">KOJO</p>
    </div>
    """
