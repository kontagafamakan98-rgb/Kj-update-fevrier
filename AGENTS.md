...
- `test_audit_none_signatures.py` rougit EN LOCAL Windows seulement (le sous-processus écrit en UTF-8, le parent décode cp1252 → `auditées` devient `auditÃ©es`) : lancer avec `PYTHONUTF8=1` pour obtenir le verdict de la CI, vert sur Linux.
