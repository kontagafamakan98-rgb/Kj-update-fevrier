...
const PaymentVerificationPage = () => {
  ...
  const handlePaymentAccountsComplete = async (paymentAccounts) => {
    ...
    try {
      ...
      const result = await PaymentAccountService.registerWithPaymentVerification(userData, paymentAccounts);
      ...
      navigate('/dashboard', {
        state: {
          message: pageT('dashboardMessage', {
            ...
            count: result.data.payment_verification.linked_accounts
          }),
          type: 'success'
        }
      });
    } catch (registrationError) {
      safeLog.error('❌ Erreur inscription avec paiement:', registrationError);
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <PaymentAccountSetup userType={userData.user_type} isRegistration={true} onComplete={handlePaymentAccountsComplete} />
