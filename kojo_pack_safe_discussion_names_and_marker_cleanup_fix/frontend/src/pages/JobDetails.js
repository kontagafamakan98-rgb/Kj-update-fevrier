    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-2 space-y-6">
          ...
          {discussionTarget?.id && (
            <div ref={discussionSectionRef} className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 space-y-4">
              ...
              <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4 min-h-[180px] space-y-3">
                {messagesLoading ? (
                  ...
                  visibleMessages.map((message) => {
                    ...
                    }, isCurrentUser ? currentUserDisplayName : (discussionTarget?.name || 'Interlocuteur'));
