...
export default function ProfileScreen({ navigation }) {
  ...
  const handleLanguageChange = () => {
    ...
    Alert.alert(
      ...
      availableLanguages.map(lang => ({
        ...
        style: currentLanguage === lang.code ? 'cancel' : 'default'
      }))
    );
  };
  ...
  const profileMenuItems = [
    ...
    ...(user?.user_type === 'worker' ? [{
      id: 'worker',
      title: 'Profil travailleur',
      icon: 'work',
      onPress: handleWorkerProfile,
    }] : []),
    {
      id: 'language',
      title: 'Langue',
      ...
      rightText: availableLanguages.find(lang => lang.code === currentLanguage)?.name,
    },
  ];
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.versionContainer}>
          <Text style={styles.versionText}>Kojo v1.0.0</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
