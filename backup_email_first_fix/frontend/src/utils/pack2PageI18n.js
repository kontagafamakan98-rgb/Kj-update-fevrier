...
const pages = {
  ...
  paymentVerification: {
    fr: {
      ...
      finalizing: 'Préparation de la vérification email...',
      checkingAccounts: 'Validation des comptes de paiement en cours',
      ...
      genericError: 'Erreur lors de la préparation de la vérification email',
      emailStepNotice: 'Après cette étape, un code Gmail sécurisé sera envoyé pour confirmer votre adresse email.',
    ...
    en: {
      ...
      finalizing: 'Preparing email verification...',
      checkingAccounts: 'Validating payment accounts',
      ...
      genericError: 'Error while preparing email verification',
      emailStepNotice: 'After this step, a secure Gmail code will be sent to confirm your email address.',
  ...
  emailVerification: {
    fr: {
      ...
      subtitle: 'On verrouille l\'inscription proprement avant l\'ouverture du dashboard.',
      ...
      verifyButton: 'Vérifier et créer mon compte',
      verifying: 'Vérification du code et création du compte...',
      ...
      emailVerified: 'Email vérifié. Finalisation du compte...',
    ...
    en: {
      ...
      subtitle: 'We lock the signup flow properly before opening the dashboard.',
      ...
      verifyButton: 'Verify and create my account',
      verifying: 'Verifying code and creating account...',
      ...
      emailVerified: 'Email verified. Finalizing account...',
