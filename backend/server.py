...
class User(BaseModel):
    ...
    first_name: str = Field(min_length=1, max_length=50, pattern=r'^[a-zA-ZÀ-ÿ\s\-\']+$')
    last_name: str = Field(min_length=1, max_length=50, pattern=r'^[a-zA-ZÀ-ÿ\s\-\']+$')
...
KOJO_PRIORITY_COUNTRIES = {
    ...
    '223': {
        'country': 'Mali',
        'orange_prefixes': ['77', '78', '79', '70'],  # Ajout 70 pour compatibilité maximale
    ...
    '225': {
        ...
        'orange_prefixes': ['77', '78', '79'],  # Pas de 70 pour Orange Côte d'Ivoire
